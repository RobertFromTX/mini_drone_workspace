...
static const unsigned char dmpMemory[MPU6050_DMP_CODE_SIZE] __attribute__((section(".flash"))) = {
			/* bank # 0 */
			,
			/* bank # 1 */
			,
			/* bank # 2 */
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x65, 0x00, 0x54, 0xFF, 0xEF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x01, 0x00, 0x00, 0x44, 0x00, 0x01, 0x00, 0x05, 0x8B, 0xC1, 0x00, 0x00, 0x01, 0x00,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x65, 0x00, 0x00, 0x00, 0x54, 0x00, 0x00, 0xFF, 0xEF, 0x00, 0x00,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			...
			/* bank # 3 */
			,
			/* bank # 4 */
			,
			/* bank # 5 */
			,
			/* bank # 6 */
			,
			/* bank # 7 */
			,
...
//int8_t GetCurrentFIFOPacket(I2C_HandleTypeDef *hi2c, uint8_t *data, uint8_t length) { // overflow proof
//    int16_t fifoC;
